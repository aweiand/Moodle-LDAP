...
/*    function user_disable($username) {
  ...
  /*
   * Esta linha foi alterada para pegar as configurações certas do LDAP
   * 
   ...
   * 
   */
            $search=ldap_read($ldapconnection, $this->filter_addslashes($memberuser), "(objectclass=*)", array($this->config->memberattribute));
